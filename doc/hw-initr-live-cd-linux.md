...
2. On the running Linux system, download the latest [Polis Masternode Tool archived binary](https://github.com/Bertrand256/polis-masternode-tool/releases) (.tar.gz) from the project page, or copy the file to the system in some other way.
...
**A copy of the commands to create the udev rules required by hardware wallets supported by PMT appears below**
