...
# Form implementation generated from reading ui file '/Users/blogin/PycharmProjects/PMT-git/src/ui/ui_config_dlg.ui'
#
...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabPolisd = QtWidgets.QWidget()
        self.tabPolisd.setObjectName("tabPolisd")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabPolisd)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabPolisd)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboPolisNetwork = QtWidgets.QComboBox(self.tabPolisd)
        self.cboPolisNetwork.setObjectName("cboPolisNetwork")
        self.cboPolisNetwork.addItem("")
        self.cboPolisNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboPolisNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabPolisd)
        ...
        self.tabWidget.addTab(self.tabPolisd, "")
...
#        self.layHardwareWallet.addWidget(self.chbHwLedgerNanoS)
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "Polis network:"))
        self.cboPolisNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboPolisNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabPolisd), _translate("ConfigDlg", "Polis network"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (PolisCentral.org)"))
