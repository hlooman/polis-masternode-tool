...
log = logging.getLogger('pmt.db_intf')
    ...
    def create_structures(self):
        try:
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS masternodes(id INTEGER PRIMARY KEY, ident TEXT, status TEXT,"
                        ...
                        " pmt_active INTEGER, pmt_create_time TEXT, pmt_deactivation_time TEXT)")

            cur.execute("CREATE INDEX IF NOT EXISTS IDX_masternodes_PMT_ACTIVE ON masternodes(pmt_active)")
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS proposals(id INTEGER PRIMARY KEY, name TEXT, payment_start TEXT,"
                        ...
                        " f_cached_endorsed INTEGER, object_type INTEGER, is_valid_reason TEXT, pmt_active INTEGER, "
                        " pmt_create_time TEXT, pmt_deactivation_time TEXT, pmt_voting_last_read_time INTEGER,"
            ...
            # has just been sent from pmt wallet or the transaction which appeared in the mempool); in this case
